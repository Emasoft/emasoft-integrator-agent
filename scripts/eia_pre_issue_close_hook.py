#!/usr/bin/env python3
"""
eia_pre_issue_close_hook.py - GitHub issue closure gate with TDD enforcement.
...
Usage:
    ...
    echo '{"tool_input":{"command":"gh issue close 42"}}' | python3 eia_pre_issue_close_hook.py

    # Direct invocation (for testing):
    python3 eia_pre_issue_close_hook.py <issue_number>
    python3 eia_pre_issue_close_hook.py 42
...
Examples:
    python3 eia_pre_issue_close_hook.py 42
    python3 eia_pre_issue_close_hook.py 123
            """,
        )
