#!/usr/bin/env python3
"""
eia_pre_push_hook.py - Branch Protection for Git Push Operations.
...
Usage:
    ...
    echo '{"tool_input":{"command":"git push"}}' | python3 eia_pre_push_hook.py

    # Direct invocation (for testing):
    python3 eia_pre_push_hook.py --command "git push origin main"
