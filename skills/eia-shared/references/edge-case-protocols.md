...
|-----------|-----------|-----------|
| No ACK received | 5 minutes | Code reviewer did not acknowledge review request |
| No progress update | 15 minutes | No partial review results posted |
| Session terminated | Immediate | AI Maestro reports agent offline |

### 3.2 Escalation Ladder

**Step 1: First Reminder (after 5 min no ACK / 15 min no progress)**
```bash
...
- Note: "Review will be reassigned in 5 minutes if no response"

**Step 4: Reassign or escalate to Orchestrator**
...
- [blocking-workflow.md](../eia-github-kanban-core/references/blocking-workflow.md) - Blocking patterns
