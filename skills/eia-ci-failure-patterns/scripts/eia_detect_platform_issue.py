...
Usage:
    python eia_detect_platform_issue.py --path /path/to/project
    python eia_detect_platform_issue.py --path . --extensions .py .js .sh
    python eia_detect_platform_issue.py --path . --json
"""
