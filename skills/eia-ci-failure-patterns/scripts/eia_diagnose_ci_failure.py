...
Usage:
    python eia_diagnose_ci_failure.py --log-file /path/to/ci.log
    cat ci.log | python eia_diagnose_ci_failure.py --stdin
    python eia_diagnose_ci_failure.py --log-file ci.log --json
"""
