...
2. Run diagnostic script: `python scripts/int_diagnose_ci_failure.py --log-file ci.log`
3. Consult the appropriate reference in `references/`

## Included Scripts

- `int_diagnose_ci_failure.py` - Analyzes CI logs to identify failure patterns
- `int_detect_platform_issue.py` - Scans source code for cross-platform issues
