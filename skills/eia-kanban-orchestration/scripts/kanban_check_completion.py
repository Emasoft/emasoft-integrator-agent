...
Usage:
    python3 kanban_check_completion.py OWNER REPO PROJECT_NUMBER [--verbose] [--json]
...
Example:
    python3 kanban_check_completion.py Emasoft my-repo 1
    python3 kanban_check_completion.py Emasoft my-repo 1 --verbose
"""
