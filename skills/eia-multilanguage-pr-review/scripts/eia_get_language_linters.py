...
Usage:
    python eia_get_language_linters.py --language python
    python eia_get_language_linters.py --languages python,javascript,rust
    python eia_get_language_linters.py --all
"""
