...
Usage:
    python3 eia_reply_to_thread.py --thread-id PRRT_xxxxx --body "Reply message"
    python3 eia_reply_to_thread.py --thread-id PRRT_xxxxx --body "Fixed" --and-resolve
...
Example:
    python3 eia_reply_to_thread.py --thread-id PRRT_kwDOxxx --body "Good catch, fixed!"
    python3 eia_reply_to_thread.py --thread-id PRRT_kwDOxxx --body "Done" --and-resolve
