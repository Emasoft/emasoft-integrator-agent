...
| Script | Purpose |
|--------|---------|
| `eia_test_pr_merged.py` | Check if PR is merged (GraphQL) |
| `eia_test_pr_merge_ready.py` | Verify all merge requirements |
| `eia_merge_pr.py` | Execute merge with strategy |
