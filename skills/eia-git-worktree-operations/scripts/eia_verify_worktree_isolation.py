...
Usage:
    python eia_verify_worktree_isolation.py --worktree-path /tmp/worktrees/pr-123
    python eia_verify_worktree_isolation.py -w /tmp/worktrees/pr-123 --main-repo /path/to/repo
"""
