#!/usr/bin/env python3
"""
eia_get_issue_context.py - Retrieve comprehensive GitHub issue metadata.
...
Usage:
    eia_get_issue_context.py --repo owner/repo --issue 123
    eia_get_issue_context.py --repo owner/repo --issue 123 --include-comments
