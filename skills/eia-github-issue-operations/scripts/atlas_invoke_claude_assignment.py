...
Usage:
    python3 atlas_invoke_claude_assignment.py --issue 123
    python3 atlas_invoke_claude_assignment.py --issue 123 --skip-workflow
    python3 atlas_invoke_claude_assignment.py --issue 123 --prepare-context-only
    python3 atlas_invoke_claude_assignment.py --issue 123 --dry-run
