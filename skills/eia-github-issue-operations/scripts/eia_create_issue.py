#!/usr/bin/env python3
"""
eia_create_issue.py - Create a new GitHub issue.

Creates a new issue in the specified repository with optional labels,
assignee, and milestone using the gh CLI.

Usage:
    eia_create_issue.py --repo owner/repo --title "Issue title"
    eia_create_issue.py --repo owner/repo --title "Bug" --body "Description" --labels "bug,P1"
    eia_create_issue.py --repo owner/repo --title "Task" --assignee "username" --milestone "v2.0"
