...
|--------|---------|---------|
| `int_get_pr_context.py` | Full metadata & status | `python3 int_get_pr_context.py --pr 123` |
| `int_get_pr_files.py` | List changed files | `python3 int_get_pr_files.py --pr 123` |
| `int_get_pr_diff.py` | Get code diff | `python3 int_get_pr_diff.py --pr 123 --stat` |
